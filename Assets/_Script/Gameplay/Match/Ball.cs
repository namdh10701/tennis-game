...
public class Ball : MonoBehaviour
{
    ...
    public void Init(MatchEvent matchEvent, SportName sportName, Transform aimingTarget)
    {
    ...
    private void OnEnable()
    {
        if (_matchEvent != null)
        {
            _matchEvent.BallHit.AddListener(side => HitBy(side));
        }
    }
    private void OnDisable()
    {
        _matchEvent.BallHit.RemoveListener(side => HitBy(side));
    }
